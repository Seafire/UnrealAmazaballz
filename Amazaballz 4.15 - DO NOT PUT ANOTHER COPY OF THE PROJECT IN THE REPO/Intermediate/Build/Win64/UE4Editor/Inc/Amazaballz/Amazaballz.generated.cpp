...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_E_Team(E_Team_StaticEnum, TEXT("/Script/Amazaballz"), TEXT("E_Team"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(AC_ProceduralLevelGenerator, 543989948);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(random_rotation_, AC_ProceduralLevelGenerator, bool);
				UProperty* NewProp_random_rotation_ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("random_rotation_"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(random_rotation_, AC_ProceduralLevelGenerator), 0x0020080000000015, CPP_BOOL_PROPERTY_BITMASK(random_rotation_, AC_ProceduralLevelGenerator), sizeof(bool), true);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				MetaData->SetValue(NewProp_random_rotation_, TEXT("Category"), TEXT("Chunks"));
				MetaData->SetValue(NewProp_random_rotation_, TEXT("ModuleRelativePath"), TEXT("Procedural/C_ProceduralLevelGenerator.h"));
				MetaData->SetValue(NewProp_random_rotation_, TEXT("ToolTip"), TEXT("Should each chunk randomly rotate itself?"));
